...
For example: - UI modules handle display and user input - Service
modules handle business logic - Data modules handle storage and
retrieval
...
Examples: - CandidateRepository - VoterRepository - PollRepository -
StationRepository
...
Emails must follow a valid format such as:
